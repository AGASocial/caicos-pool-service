...
AI-powered development team coordination plugin for the Cadenza pool service platform. Orchestrates four specialized agents working together to design, build, and validate the Cadenza MVP.
...
3. Select the cadenza-team plugin file
4. Authorize access
...
**cadenza-team v0.1.0** (MVP Release)

Built for Cadenza pool service platform.
Compatible with Cowork mode.

---

**Ready to build Cadenza?** Start with: `/status team`
