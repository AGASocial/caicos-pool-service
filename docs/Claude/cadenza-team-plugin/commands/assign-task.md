---
name: "/assign-task"
description: Assign a feature or task to the appropriate Cadenza team member. Automatically routes to Master Agent who delegates to the right specialist (NextJS, React Native, or QA).
---

# /assign-task

Delegate a feature or task to the Cadenza development team.
