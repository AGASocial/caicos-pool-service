...
COMMENT ON TABLE cadenza_route_stop_schedules IS
...
INSERT INTO cadenza_route_stop_schedules (
  route_stop_id,
  day_of_week,
  service_frequency,
  week_ordinal,
...
SELECT
  ...
  DATE '2000-01-01',
  NULL
FROM cadenza_route_stops s
WHERE NOT EXISTS (
  SELECT 1
  FROM cadenza_route_stop_schedules x
...
CREATE TRIGGER set_updated_at
  BEFORE UPDATE ON cadenza_route_stop_schedules
