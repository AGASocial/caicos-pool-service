...
description: "Generate production-ready Next.js API routes, Supabase functions, or database migrations for Cadenza backend. Specify operation type, data model, authentication requirements, and integration points."
---
...
Load skill: **Cadenza Next.js Backend API**
