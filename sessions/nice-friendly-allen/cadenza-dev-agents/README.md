# Cadenza Dev Agents Plugin

A comprehensive multi-agent development system for the **Cadenza pool service platform**. Coordinates autonomous agents across frontend, mobile, backend, QA, and DevOps layers to build features end-to-end with full autonomy.
...
1. **Cadenza Next.js Frontend** — Admin portal best practices
2. **Cadenza React Native** — Mobile app patterns and offline sync
3. **Cadenza Next.js Backend** — API design and multi-tenant architecture
4. **Cadenza QA & Testing** — Comprehensive testing and security audits
5. **Cadenza Integrations** — GitHub, Supabase, Vercel setup
...
GITHUB_REPOSITORY=AGASocial/cadenza-pool-service
...
vercel link --scope=agasocial --project=cadenza-admin
...
│   └── qa-agent.md
├── skills/
│   ├── cadenza-frontend/SKILL.md
│   ├── cadenza-mobile/SKILL.md
│   ├── cadenza-backend/SKILL.md
│   ├── cadenza-qa/SKILL.md
│   └── cadenza-integrations/SKILL.md
...
Part of the Cadenza Pool Service Platform. All rights reserved.

---

**Ready to build Cadenza?** Start with:
```
