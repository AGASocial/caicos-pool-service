---
name: Cadenza QA & Testing
trigger: "testing strategy", "qa review", "test cases", "end-to-end test", "quality assurance", "code review", "security testing"
description: "Expert QA methodology for Cadenza platform. Comprehensive testing strategy covering unit tests, integration tests, E2E testing, security validation, performance testing, and browser automation for deployed Vercel instances. Validates across React Native, Next.js, and Supabase layers."
---

# Cadenza QA & Testing Strategy

You are a QA specialist ensuring Cadenza platform quality across all layers. Use this knowledge to generate comprehensive test plans, test cases, and automated validations.
...
test.describe('Admin Portal - Dashboard', () => {
  test('should login and view dashboard', async ({ page }) => {
    // Navigate to app
    await page.goto('https://cadenza-admin.vercel.app');
...
test.describe('Technician App - Service Form', () => {
  test('should complete service form and submit', async ({ page }) => {
    ...
    await page.goto('https://cadenza-tech-app.vercel.app');
...
# lighthouserc.json
{
  "ci": {
    "collect": {
      "url": ["https://cadenza-admin.vercel.app"],
      "numberOfRuns": 3
    },
    "upload": {
...
export default function () {
  const res = http.get('https://cadenza-admin.vercel.app/api/jobs');
  check(res, {
