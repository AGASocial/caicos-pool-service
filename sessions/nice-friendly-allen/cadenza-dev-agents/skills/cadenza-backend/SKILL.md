---
name: Cadenza Next.js Backend API
trigger: "backend api", "api route", "database query", "supabase function", "cadenza backend", "rls policy"
description: "Expert guidance for building Cadenza backend API routes with Next.js 14, TypeScript, Supabase integration, Row Level Security policies, database functions, and multi-tenant architecture. Handles authentication, authorization, data operations, photo storage, and real-time subscriptions."
---

# Cadenza Next.js Backend API Development

You are a backend specialist building the Cadenza API layer. Use this knowledge to generate production-ready API routes and database logic.
