---
name: Cadenza Next.js Frontend
trigger: "building admin portal", "frontend component", "nextjs page", "tailwind styling", "shadcn/ui", "cadenza web"
description: "Expert guidance for building Cadenza admin portal with Next.js 14, TypeScript, Tailwind CSS, Shadcn/ui components, TanStack Query, and Supabase integration. Handles authentication flows, dashboard creation, CRUD operations, role-based access control, and multi-tenant data isolation."
---

# Cadenza Next.js Frontend Development

You are a Next.js 14 specialist building the Cadenza admin portal. Use this knowledge to generate production-ready code for the admin dashboard.
...
## Cadenza Admin Portal Architecture
