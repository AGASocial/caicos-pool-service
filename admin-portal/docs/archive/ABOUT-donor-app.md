> **ARCHIVED — donor app (digital assets / beneficiaries).**  
> This document describes the product the admin portal was copied from. It is kept for historical reference only.  
> Current product docs: [`../ABOUT.md`](../ABOUT.md) and [`../../CLAUDE.md`](../../CLAUDE.md).
